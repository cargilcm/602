...
public class NCSU implements SchoolAdapter {
	private static String CLASSES_URL = "http://web.archive.org/web/20030901040600/http://www2.acs.ncsu.edu/reg_records/tracs_bk/";
...
public NCSU () {
	_departments = new String[][] {
		{"COM"}/*AGI", "ACC", "ADN", "AEE", "AFS", "ALS", "ANS", "ANT", "ARC",
...
/*	
	tokens[0] = s1;//s1.substring(132, 137);		//0 - COURSE PRE
	//System.out.println("[0] "+tokens[0]);
	...
	*/
	...
	if (tokens[6].equals("var"))
		...
		credit = (int)Double.parseDouble("0");
	...
	/*StudentClass result = new StudentClass(null,
		new Course(null		, null), 	  null,	
		null, null,     null,     0, credit);*/
...
//				System.out.println(line);
				String lineAgain=line.substring(48,59);
				line2 = reader.readLine();
				String line22=lineAgain.substring(7,lineAgain.length());
				lineAgain=lineAgain.substring(0,6);
				line3 = reader.readLine();
				//System.out.println(lineAgain+"\n"+line22);//\n"+line3);
				c = parseClassData(lineAgain, line22, line3);
		...
		throw new IOException("Invalid cache file2: " + f + "\n"+e);
	...
	for (int i = 0; i < c2.length; i++) {
		...
		//System.out.println(_courses[k][i]);
	}
